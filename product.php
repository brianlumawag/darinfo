...
<body>
    ...
    <div class="container-fluid py-5">
      <div class="container">
          <div class="mx-auto text-center mb-5" style="max-width: 500px;">
              ...
              <h1 class="display-5"><a href="https://agriventures.tech/">KaSaMa</a></h1>
          </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    <div style="text-align: center;" class="d-block bg-white h-100 text p-5 pb-lg-0">
                      ...
                      In the dynamic world of agriculture, where the demand for sustainable and efficient solutions is at its peak, Agriventures.tech proudly presents KASAMA E-Marketing, an innovative e-marketing platform designed to transform the way agricultural products are bought and sold. KASAMA E-Marketing brings together farmers, producers, distributors, and buyers on a single digital platform, fostering connections and empowering participants in the agricultural value chain.<img class="img-fluid" src="img/feature.png" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="text-white mb-5">
    ...
    <center><h1 class="display-5 text-black">KaSaMa E-Marketing Platform</h1></center>
    <div class="video-container">

       <video controls>
         <source src="img/kasama.mp4" type="video/mp4">
