...
<?php } ?>
 ...
 <nav>
  ...
  <input class="form-control p-3" type="text" name="keyword" placeholder="Search...">
  <button  class="btn btn-primary px-4" type="submit">Search<i class="bi bi-search"></i></button>
</form>
